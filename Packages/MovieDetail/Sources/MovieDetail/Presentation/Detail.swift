...
public struct Detail: SwiftUI.View {
...
private extension Detail {
    ...
    func exploreSection(geometry: GeometryProxy) -> some SwiftUI.View {
        VStack {
            ...
            selectedSection(width: width, geometry: geometry)
        }
        .padding(.top, 16)
    }

    @ViewBuilder
    func selectedSection(width: CGFloat, geometry: GeometryProxy) -> some SwiftUI.View {
